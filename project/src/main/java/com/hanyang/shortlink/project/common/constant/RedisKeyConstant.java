...
public class RedisKeyConstant {
     ...
     * 短链接跳转前缀 Key
     */
    public static final String SKIP_SHORT_LINK_KEY = "short-link:skip:%s";

    /**
     * 短链接空值跳转前缀 Key
     */
    public static final String SKIP_IS_NULL_SHORT_LINK_KEY = "short-link:is-null:skip_%s";

    /**
     * 短链接跳转锁前缀 Key
     */
    public static final String LOCK_SKIP_SHORT_LINK_KEY = "short-link:lock:skip:%s";

    /**
     * 短链接修改分组 ID 锁前缀 Key
     */
    public static final String LOCK_GID_UPDATE_KEY = "short-link:lock:update-gid_%s";
